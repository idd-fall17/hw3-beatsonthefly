#ifndef LSM303_SOFT_h
#define LSM303_SOFT_h
...
*/
template <typename T> float LSM303Soft::heading(vector<T> from)
{
...
template <typename Ta, typename Tb, typename To> void LSM303Soft::vector_cross(const vector<Ta> *a, const vector<Tb> *b, vector<To> *out)
{
...
template <typename Ta, typename Tb> float LSM303Soft::vector_dot(const vector<Ta> *a, const vector<Tb> *b)
{
