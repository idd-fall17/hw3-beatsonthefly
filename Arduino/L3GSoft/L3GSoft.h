...
template <typename Ta, typename Tb, typename To> void L3GSoft::vector_cross(const vector<Ta> *a, const vector<Tb> *b, vector<To> *out)
{
...
template <typename Ta, typename Tb> float L3GSoft::vector_dot(const vector<Ta> *a, const vector<Tb> *b)
{
